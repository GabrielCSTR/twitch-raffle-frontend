...
<template>
    <div class="flex flex-col shadow-lg p-5 min-h-96">
        <h1 class="glow-title uppercase text-3xl font-semibold text-center text-gray-800 lg:text-4xl dark:text-white">Roleta de SEGUIDORES</h1>
        <p class="max-w-2xl mx-auto mt-4 text-center text-gray-500 xl:mt-6 dark:text-gray-300">
            Sorteio de seguidores que permite que o organizador escolha um ganhador aleatorio entre os seguidores do canal! 
        </p>
        <div class="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12">
                    <div class="flex items-center justify-between px-8 py-4 border border-purple-700 cursor-pointer rounded-xl ">
                        <div class="flex flex-col items-center space-y-1">
                            ...
                            <h2 class="text-lg font-medium text-gray-700 sm:text-xl dark:text-gray-200">Seguidores:</h2>
                        </div>
